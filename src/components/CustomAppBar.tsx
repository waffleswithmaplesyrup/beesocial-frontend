...
import { AppBar, Box, Button, Typography, IconButton, Avatar, Menu, MenuItem } from '@mui/material';
...
const CustomAppBar: React.FC = () => {
    ...
    // Sample user profile picture URL; replace this with user's actual profile picture
